...
fuzzy.simpleFilter = function(pattern, arr, getStrToTest) {
...
//
fuzzy.filter = function(pattern, arr, template, getStrToTest) {
  getStrToTest = getStrToTest || function(el) {
    return el;
  };
  return arr.reduce(function(prev, curr, idx, arr) {
    ...
    if(rendered != null) {
      prev.push({string: rendered, index: idx, original: curr});
    }
    return prev;
  }, []);
};
